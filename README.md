...
graph TD
    ...
    %% ===== CASOS DE USO =====
    UC1[/"Configurar Dispositivos"/]
    UC2[/"Agendar Alarmes"/]
    UC3[/"Ativar Manualmente"/]
    UC4[/"Visualizar Logs"/]
    UC5[/"Manutenção Hardware"/]
    ...
    %% ===== EXTENSÕES =====
    UC3 -.->|Requer WiFi| CHECK(("Verificar Conexão"))
    UC5 -.->|Emergência| RESET(("Reset Físico"))
    
    %% ===== ESTILOS =====
    style ADMIN fill:#2ecc71,color:white
    style PROF fill:#3498db,color:white
    style TEC fill:#e74c3c,color:white
    style UC1,UC2,UC3,UC4,UC5 fill:#f39c12,stroke:#d35400
```
---
